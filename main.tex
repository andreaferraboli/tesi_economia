...
\usepackage{graphicx}   % Inserimento immagini (loghi frontespizio)
...
\begin{titlepage}
    \begin{center}
        ...
        \includegraphics[width=0.30\textwidth]{images/logo_ema.png}
        ...
        \includegraphics[width=0.32\textwidth]{images/Unimi-logo.png}
...
\input{capitoli/00_introduzione}   % usare \chapter*{Introduzione} + \addcontentsline

% Capitoli numerati
\input{capitoli/01_fondamenta}     % usare \chapter{Titolo}
\input{capitoli/02_riforme}
\input{capitoli/03_modelli}
\input{capitoli/04_futuro}

% Conclusioni: non numerate, ma presenti nell'indice
\input{capitoli/05_conclusioni}    % usare \chapter*{Conclusioni} + \addcontentsline

% Bibliografia e Sitografia: non numerate
\input{capitoli/06_bibliografia}   % usare \chapter*{Bibliografia} + \addcontentsline
