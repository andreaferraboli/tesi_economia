...
medio annuo, contro lo 0,12\% del decennio 2015-2025, e il blocco del solo
...
annui: 9.900 euro). Il tasso nozionale è posto, per semplicità, all'$1{,}5\%$: è
un valore di comodo, perché qui conta solo il divario fra lordo e netto, mentre la
capitalizzazione effettiva del montante segue la crescita del PIL nominale, attorno
al 2,7\% medio nelle proiezioni RGS (0,7\% reale più un deflatore del 2\%)
\cite{MEF_RGS2025_NdA}. La calibrazione realistica dei tassi di sostituzione è
ripresa nel Capitolo~4.
\[
\begin{aligned}
M_C^{NDC}
