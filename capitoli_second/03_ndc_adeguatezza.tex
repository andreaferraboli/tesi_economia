...
MEF_RGS2025_NdA, FrancoTommasino2020}. La spesa pensionistica in rapporto al
...
\noindent
La tabella nasconde una verità scomoda. Il problema italiano non è tanto
mancanza di leve quanto eccesso di vincoli politici. Le tre leve a costo
...
cima alla classifica europea. Il debito pubblico, attualmente al 137\% del
PIL, non consente espansioni straordinarie. Le riforme percorribili sono
...
automatico della longevità, e a essa va attribuito più di un terzo della
riduzione cumulata di oltre sessanta punti percentuali di PIL nella spesa
pensionistica garantita dalle riforme del 2004-2024 \cite{MEF_RGS2025_NdA}.
...
costo aggregato non è stimato dall'autore. Una stima conservativa, ottenuta
applicando la proposta al 62\% di pensioni anticipate liquidate ai dipendenti
nel 2022 \cite{Gronchi2024}, indica un recupero plausibile dell'ordine di tre
o quattro miliardi annui a regime, distribuiti sulla coorte effettivamente
avvantaggiata dal dispositivo attuale \todo{VERIFICA DATO: stima recupero
da assegno di accompagnamento}.
...
\medskip
\noindent
La proposta di una \emph{pensione contributiva di garanzia} colma la distanza
fra la pensione NDC calcolata sui contributi effettivi e una soglia di
adeguatezza pari a circa l'120\% dell'assegno sociale, attraverso un
...
il tredici novembre 2024. La Corte ha statuito che \guillemotleft{}non sussiste un
...
L'osservatorio sui conti pubblici italiani, ricalcolando l'effetto su un
...
diciassette miliardi annui a regime \cite{OCPI2026}.
...
L'osservatorio sottolinea che \guillemotleft{}con tutta probabilità si interverrà sul
tema sempre all'ultimo, quando i buoi ormai saranno tutti scappati \guillemotright{}
\cite{OCPI2026}, riconoscendo che il principio dell'invarianza nominale delle
...
aggiuntivi \cite{MEF_RGS2025}. Il capitolo successivo dedicato al secondo
pilastro approfondisce le ragioni per cui l'add-on, oggi sotto-utilizzato
(le risorse del secondo pilastro italiano valgono il 9,5\% del PIL contro
oltre il 200\% in Olanda e Danimarca \cite{FrancoTommasino2020}), è una
...
finanziamento esplicito di una spesa stimabile in trenta-quaranta miliardi
annui attraverso imposte dirette o indirette \cite{Artoni2014, BosiGuerra2022}.
...
italiano \cite{Mazzaferro2023}. La cifra rappresenta il sussidio implicito
...
attivamente, e l'adesione attuale è ferma a un lavoratore su tre
\cite{MEF_RGS2025}; la perequazione selettiva non tocca l'adeguatezza dei
