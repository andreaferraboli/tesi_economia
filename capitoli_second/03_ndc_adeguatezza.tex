...
\cite{Fornero2018, Bosi2018}. Quanto pesi davvero, però, è controverso. Franco,
...
\cite{FrancoMarinoZotteri2004}; sulla stessa linea scettica si colloca chi dubita
che l'indicatore dica qualcosa di operativo \cite{Altiparmakov2011}. Resta il punto
qualitativo: il debito non è una leva di riequilibrio del sistema, ma il modo di
...
capitalizzato, e insieme accantonare il proprio risparmio previdenziale.
Sostenere che il solo dirottamento dei contributi liberi le risorse per coprire
quell'onere ne sottostima il costo, e l'evidenza accumulata da allora lo mostra
con nettezza.
...
registrato fra il 2015 e il 2025: un ritmo quasi nove volte superiore a quello
storico recente, tecnicamente plausibile ma non garantito. Se la traiettoria di
