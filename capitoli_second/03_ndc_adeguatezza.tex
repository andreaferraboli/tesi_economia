...
costruita in questa sede applicando la proposta al 62\% di pensioni anticipate
liquidate ai dipendenti nel 2022 \cite{Gronchi2024}, suggerisce un recupero
plausibile attorno a tre o quattro miliardi annui a regime, distribuiti sulla
coorte effettivamente avvantaggiata dal dispositivo attuale~\todo{VERIFICA DATO:
stima di recupero costruita dall'autore, non presente nella fonte}.
...
annui~\todo{VERIFICA DATO: cifra non confermata nelle fonti citate} attraverso
imposte dirette o indirette \cite{Artoni2014, BosiGuerra2022}.
