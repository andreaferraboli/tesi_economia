...
\noindent
C'è una variabile che nessuna proiezione previdenziale incorpora fino in fondo. Il
denominatore del metodo contributivo è il monte contributivo, e quel monte è reddito
da lavoro: se l'automazione sposta una quota crescente del valore prodotto dal lavoro
al capitale, la base del sistema a ripartizione si erode a prescindere
dall'efficienza della formula. Il terzo capitolo ha soppesato il contributo
sull'automazione e ne ha mostrato il limite: l'imposta sui robot che la teoria
giudica efficiente è piccola, e tassare la tecnologia da cui dipende il recupero di
produttività su cui poggia la sostenibilità rischia di indebolire la condizione che
dovrebbe difendere. È una risposta alla crisi fiscale del breve periodo, non alla
domanda di fondo.

E la domanda di fondo è strutturale. Il contratto sociale della ripartizione è stato
scritto per un mondo di lavoratori dipendenti a tempo pieno, con carriere lineari e
demografia in espansione, e nessuna di queste premesse regge più: le carriere sono
discontinue, i salari reali stagnano, l'indice di dipendenza degli anziani raggiunge
il 62,3\% nel 2070 \cite{MEF_RGS2025}. L'architettura che sopravvive a questo
scenario è quella che Bosi indica con la separazione fra funzione previdenziale e
funzione assistenziale \cite{Bosi2018}: finanziare con la fiscalità generale la
soglia minima garantita a tutti e lasciare alla contribuzione sul reddito la sola
componente proporzionale. Un sistema così non dipende solo dal reddito da lavoro per
garantire il proprio pavimento, e regge anche se il lavoro, nel valore aggregato,
vale meno. È la direzione verso cui guardare, a condizione di porre la domanda giusta
