\chapter*{Capitolo 2. Il Corto Circuito: Analisi delle Criticità del Sistema Vigente}
...
Il terzo termine, \(\text{POP}/N_l\), è l'inverso del tasso di occupazione e rivela come la bassa partecipazione femminile italiana abbia storicamente aggravato il divario tra massa contributiva e prestazioni da erogare~\cite{SlideCorso2025}. Nell'Italia degli anni Novanta tutte e quattro le componenti spingevano nella direzione sbagliata: il rapporto \(S_p/\text{PIL}\) aveva già raggiunto il 13,3\% nel 1990 su una traiettoria non decrescente, rendendo inevitabile la stagione delle grandi riforme descritta nel Capitolo 1~\cite{Bosi2018}.
