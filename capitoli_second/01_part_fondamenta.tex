...
con \(g\) pari alla media mobile quinquennale del tasso di crescita del PIL nominale, \(C_j = c \cdot S_j\) e \(c = 0{,}33\) per i lavoratori dipendenti. Il coefficiente di trasformazione si ricava imponendo l'equilibrio finanziario tra montante e pensioni attese~\cite{RosenGayerRapallini2023}:
